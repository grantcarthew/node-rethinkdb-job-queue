...
module.exports = function () {
  test('enums test', (t) => {
    ...
    try {
      ...
      t.equal(Object.keys(enums.jobStatus).length, 8, 'Enums jobStatus has has correct number of keys')
      t.equal(Object.keys(enums.queueStatus).length, 15, 'Enums queueStatus has correct number of keys')
      ...
      t.equal(Object.keys(enums.error).length, 11, 'Enums error has has correct number of keys')
    } catch (err) {
