  ...
  return new Promise((resolve, reject) => {
    test('db-job-failed test', (t) => {
      ...
      q.addJob(job).then((savedJob) => {
        ...
        t.ok(retry1[0].log[0].queueMessage.startsWith(enums.message.failed), 'Log queueMessage is correct')
        ...
        t.ok(retry2[0].log[1].queueMessage.startsWith(enums.message.failed), 'Log queueMessage is correct')
        ...
        t.ok(retry3[0].log[2].queueMessage.startsWith(enums.message.failed), 'Log queueMessage is correct')
        ...
        t.ok(failed[0].log[3].queueMessage.startsWith(enums.message.failed), 'Log queueMessage is correct')
